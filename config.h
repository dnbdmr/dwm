...
static const char normbordercolor[]	= "#201020";
static const char normfgcolor[]		= "#eeeeee";
static const char selfgcolor[]		= "#000000";
static const char selbordercolor[]	= "#40ff90";
static const char selbgcolor[]		= "#20e0a0";
...
#define SUPERKEY Mod1Mask
#define TAGKEYS(KEY,TAG) \
	{ MODKEY,                       KEY,      viewall,           {.ui = 1 << TAG} }, \
	{ MODKEY|SUPERKEY,              KEY,      view,        {.ui = 1 << TAG} }, \
...
static Key keys[] = {
	...
	TAGKEYS(                        XK_8,                      7)
	TAGKEYS(                        XK_9,                      8)
	{ MODKEY,						XK_z,      spawn,			SHCMD("light-locker-command -l && systemctl suspend") },
	...
	{ 0,							XF86XK_AudioMute, spawn, SHCMD("pactl set-sink-mute @DEFAULT_SINK@ toggle && pkill -37 dwmblocks") },
};
